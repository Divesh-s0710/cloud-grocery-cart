...
<input name="noapi" type="hidden" value="1" /><?php } ?>
	...
	case 2:
		...
		if((is_numeric(str_replace(':','',str_replace('.','',$dbhost))) || strstr($dbhost,':443') || stristr($dbhost,'db4free') || stristr($dbhost,'freesqldatabase')) && $dbhost!='127.0.0.1') define( 'DB_ERROR_CONNECTION', true );
